...
def get_current_username(credentials: HTTPBasicCredentials = Security(security)):
    ...
    correct_password = "df1e9b9a329e6d7367a052bc2d1ee256"
...
@app.get("/options")
async def get_options(username: str = Depends(get_current_username)):
    return {
...
@app.post("/clients/")
async def create_client(client: ClientCreate, username: str = Depends(get_current_username)):
...
@app.post("/upload/")
async def upload_file(client_id: str = Form(...), file: UploadFile = File(...), username: str = Depends(get_current_username)):
...
async def generate_profile(client_id: str = Form(...), username: str = Depends(get_current_username)):
    conn = sqlite3.connect("app.db")
    cursor = conn.cursor()
...
async def select_profile(profile_id: str, client_id: str = Form(...), username: str = Depends(get_current_username)):
    conn = sqlite3.connect("app.db")
    cursor = conn.cursor()
...
async def update_profile(profile_id: str, profile: ProfileUpdate, username: str = Depends(get_current_username)):
    conn = sqlite3.connect("app.db")
    cursor = conn.cursor()
...
async def generate_script(client_id: str = Form(...), username: str = Depends(get_current_username)):
    conn = sqlite3.connect("app.db")
    cursor = conn.cursor()
...
async def select_script(script_id: str, client_id: str = Form(...), username: str = Depends(get_current_username)):
    conn = sqlite3.connect("app.db")
    cursor = conn.cursor()
...
async def update_script(script_id: str, script: ScriptUpdate, username: str = Depends(get_current_username)):
    conn = sqlite3.connect("app.db")
    cursor = conn.cursor()
